...
import { createTicket, getTickets, getTicket, addComment, updateTicket, uploadAttachment, deleteTicket, cleanupTickets, deleteAttachment, downloadAttachment } from '../controllers/ticketController';
...
router.get('/:id/attachments/:attachmentId/download', authenticateToken, (downloadAttachment as unknown) as express.RequestHandler);
